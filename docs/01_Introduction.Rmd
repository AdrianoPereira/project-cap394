...
```{r type-lightning, fig.cap="Principais tipos de descargas atmosféricas. Adptado de [NOAA](https://www.nssl.noaa.gov/education/svrwx101/lightning/types/).", fig.scap="Short caption", echo = FALSE}
knitr::include_graphics('images/types-lightning.png', dpi = NA)
```
